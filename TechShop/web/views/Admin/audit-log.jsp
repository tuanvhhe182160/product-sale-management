...
<div class="container-fluid px-4 py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2 class="mb-0 text-gray-800">
            <i class="fas fa-shield-alt text-danger me-2"></i> Nhật Ký Hệ Thống (Audit Logs)
        </h2>
            ...
            <form action="${pageContext.request.contextPath}/admin/audit-logs" method="GET" class="row g-3 align-items-end">
                ...
                <div class="col-md-3">
                    ...
                    <input type="text"
                           name="searchKeyword"
                           class="form-control"
                           placeholder="Tên user, entity, chi tiết..."
                           value="${searchKeyword}">
                </div>
    ...
    <div class="card shadow-sm border-0">
                            ...
                            <c:otherwise>
                                ...
                                <c:forEach items="${logs}" var="log">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ${log.createdAt.toString().replace('T',' ').substring(0,19)}
                                        </td>
        ...
        <c:if test="${totalPages > 1}">
            ...
            <div class="card-footer bg-white">
                ...
                <c:if test="${endLog > totalLogs}">
                    <c:set var="endLog" value="${totalLogs}" />
                </c:if>
                
                <div class="d-flex justify-content-between align-items-center">
                    <div class="text-muted small">
                        Showing <strong>${startLog}-${endLog}</strong> of 
                    ...
                    <nav>
                        <ul class="pagination pagination-sm mb-0">
                            ...
                            <c:if test="${currentPage > 1}">
                                <li class="page-item">
                                    <a class="page-link"
                                       href="?page=${currentPage-1}&startDate=${startDate}&endDate=${endDate}&actionFilter=${actionFilter}&searchKeyword=${searchKeyword}">
                            ...
                            <c:forEach begin="${startPage}" end="${endPage}" var="p">
                                ...
                                <li class="page-item ${p == currentPage ? 'active' : ''}">
                                    ...
                                    <a class="page-link"
                                       href="?page=${p}&startDate=${startDate}&endDate=${endDate}&actionFilter=${actionFilter}&searchKeyword=${searchKeyword}">
                                        ${p}
                                    </a>
                                </li>
                            </c:forEach>
                ...
                <div class="col-md-3">
                    <label class="form-label fw-bold text-muted small">Từ khóa (Tên, Chi tiết)</label>
                    <input type="text" name="searchKeyword" class="form-control" placeholder="Nhập để tìm kiếm..." value="${searchKeyword}">
                </div>
                <div class="col-md-1">
                        ...
                        <c:choose>
                            <c:when test="${empty logs}">
                                <tr>
                                    <td colspan="7" class="text-center text-muted py-4">
                                        <i class="fas fa-folder-open fa-2x mb-2 text-secondary d-block"></i>
                                        Không tìm thấy nhật ký nào phù hợp với điều kiện lọc.
                                    </td>
                                </tr>
                            </c:when>
                            <c:otherwise>
                                <c:forEach items="${logs}" var="log">
                                    <tr>
                                        ...
                                        <td>
                                            <span class="badge bg-info text-dark border">${log.action}</span>
                                        </td>
                                        <td>
                                            <c:if test="${not empty log.entityType}">
                                                ${log.entityType} 
                                        ...
                                        <td class="small text-truncate" style="max-width: 250px;" title="${log.details}">
                                            ${log.details}
                                        </td>
                                    </tr>
                                </c:forEach>
