        ...
        <div class="col-lg-8">
            <div class="card border-0 shadow-sm h-100">
                <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
                    <h5 class="mb-0"><i class="fas fa-chart-bar text-primary me-2"></i>Top 5 S?n ph?m bán ch?y nh?t trong 30 ngày qua</h5>
                </div>
                <div class="card-body">
                ...
                <div class="card-body">
                    <div class="list-group list-group-flush mb-3">
                        <a href="${pageContext.request.contextPath}/user" class="list-group-item list-group-item-action border-0 px-0">
                            <i class="fas fa-users text-primary me-2"></i> Qu?n lý nhân viên
                        </a>
                        <a href="${pageContext.request.contextPath}/admin/sales-report?reportType=product" class="list-group-item list-group-item-action border-0 px-0">
                            <i class="fas fa-chart-pie text-info me-2"></i> Báo cáo doanh s? S?n ph?m
                        </a>
                        <a href="${pageContext.request.contextPath}/admin/sales-report?reportType=branch" class="list-group-item list-group-item-action border-0 px-0">
                            <i class="fas fa-map-marked-alt text-success me-2"></i> Báo cáo doanh s? Chi nhánh
                        </a>
                    </div>
                    <hr>
        ...
        <div class="col-md-6 col-lg-3">
            <div class="card border-0 shadow-sm h-100">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <p class="text-muted mb-1 small">Hóa ??n hôm nay</p>
        ...
        <div class="col-md-6 col-lg-3">
            <div class="card border-0 shadow-sm h-100">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <p class="text-muted mb-1 small">T?ng H? hoàn thành</p>
        ...
        <div class="col-md-6">
            <div class="card border-0 shadow-sm h-100">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <p class="text-muted mb-1 small">S?n ph?m t?n kho (chi nhánh)</p>
...
<c:if test="${dashboardType == 'accounting'}">
        ...
        <div class="col-md-6 col-lg-4">
            <div class="card border-0 shadow-sm h-100 border-start border-primary border-4">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <p class="text-muted mb-1 small fw-bold text-uppercase">L?i Nhu?n (30 Ngày)</p>
        ...
        <div class="col-md-6 col-lg-4">
            <div class="card border-0 shadow-sm h-100 border-start border-warning border-4">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <p class="text-muted mb-1 small fw-bold text-uppercase">Hóa ??n (30 Ngày)</p>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-white py-3">
                    <h5 class="mb-0"><i class="fas fa-toolbox text-secondary me-2"></i>Công c? Tài chính</h5>
                </div>
                <div class="card-body">
                        ...
                        <div class="col-md-4">
                            <a href="${pageContext.request.contextPath}/report/financial" class="text-decoration-none">
                                <div class="p-4 border rounded bg-light hover-shadow transition-all">
                                    ...
                                    <p class="small text-muted mb-0">Xem và xu?t file (CSV/Excel) doanh thu, l?i nhu?n.</p>
                                </div>
                            </a>
                        </div>
                        ...
                        <div class="col-md-4">
                            <a href="${pageContext.request.contextPath}/accounting/invoices" class="text-decoration-none">
                                <div class="p-4 border rounded bg-light hover-shadow transition-all">
                                    ...
                                    <h6 class="text-dark fw-bold">Tra C?u Hóa ??n</h6>
                                    <p class="small text-muted mb-0">Xem chi ti?t và ??i soát các giao d?ch bán hàng.</p>
                                </div>
                            </a>
                        </div>
                        ...
                        <div class="col-md-4">
                            <a href="${pageContext.request.contextPath}/accounting/close-period?branchId=${sessionScope.branchId}" class="text-decoration-none">
                                <div class="p-4 border rounded bg-light hover-shadow transition-all">
                                    ...
                                    <h6 class="text-dark fw-bold">Ch?t K? K? Toán</h6>
                                    <p class="small text-muted mb-0">Khóa s? d? li?u giao d?ch theo tháng/quý.</p>
                                </div>
                            </a>
                        </div>
                    </div>
